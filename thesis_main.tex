\documentclass[12pt]{packages/ociamthesis}
...
\usepackage{lipsum}  
\usepackage{ragged2e}
\usepackage{packages/hangcaption}
\usepackage{palatino}
\usepackage{color}
\usepackage{graphicx}
...
\author{Your name}
\college{Departament de Ci\`{e}ncies de la Computaci\'{o} \\  Universitat Polit\`ecnica de Catalunya} 

\degree{Doctor of Philosophy}
\degreedate{Barcelona, Month YYYY}     
